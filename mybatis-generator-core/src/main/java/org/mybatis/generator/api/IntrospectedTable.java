...
public abstract class IntrospectedTable {
    ...
    public String getSelectByBasicParam() {
        return tableConfiguration.getSelectByBasicParam();
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectBasicParamStatementId("selectByBasicParam"); //$NON-NLS-1$
    ...
    public void setSelectBasicParamStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SELECT_BY_BASIC_PARAM_ID, s);
    }
    ...
    public String getSelectByBasicParamStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_BY_BASIC_PARAM_ID);
    }
