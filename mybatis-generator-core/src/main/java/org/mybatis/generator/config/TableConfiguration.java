...
public class TableConfiguration extends PropertyHolder {
    ...
    private boolean selectByBasicParamStatementEnabled;
    ...
    private String selectByBasicParam;
    ...
    public TableConfiguration(Context context) {
        ...
        selectByBasicParamStatementEnabled = true;
    ...
    public XmlElement toXmlElement() {
        ...
        if (!selectByBasicParamStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableSelectByBasicParam", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        ...
        if (stringHasValue(selectByBasicParam)) {
            xmlElement.addAttribute(new Attribute(
                    "selectByBasicParam", selectByBasicParam)); //$NON-NLS-1$
        }
    ...
    public String getSelectByBasicParam() {
        return selectByBasicParam;
    }

    public void setSelectByBasicParam(String selectByBasicParam) {
        this.selectByBasicParam = selectByBasicParam;
    }

    public boolean isSelectByBasicParamStatementEnabled() {
        return selectByBasicParamStatementEnabled;
    }

    public void setSelectByBasicParamStatementEnabled(boolean selectByBasicParamStatementEnabled) {
        this.selectByBasicParamStatementEnabled = selectByBasicParamStatementEnabled;
    }
}
