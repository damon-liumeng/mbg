...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addSelectByBasicParamMethod(interfaze);
    ...
    protected void addSelectByBasicParamMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateSelectByBasicParam()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new SelectByBasicParamMethodGenerator(false);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
