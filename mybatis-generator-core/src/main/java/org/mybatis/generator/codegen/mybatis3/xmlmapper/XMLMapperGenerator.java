...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addSelectByBasicParamElement(answer);
    ...
    protected void addSelectByBasicParamElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateSelectByBasicParam()) {
            AbstractXmlElementGenerator elementGenerator = new SelectByBasicParamElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
